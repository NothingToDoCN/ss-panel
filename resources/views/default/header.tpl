...
<head>
    ...
    <link href="/assets/materialize/css/materialize.min.css?v=1" type="text/css" rel="stylesheet" media="screen,projection"/>
    <link href="/assets/materialize/css/style.css" type="text/css" rel="stylesheet" media="screen,projection"/>
</head>
<body>
<div id='wx_logo' style='margin:0 auto;display:none;'><img src='/assets/public/img/logo.jpg' alt="logo"/></div>
<nav class="light-blue lighten-1" role="navigation">
    <div class="nav-wrapper container"><a id="logo-container" href="/" class="brand-logo">{$config["appName"]}</a>
        <ul class="right hide-on-med-and-down">
            ...
            {else}
                <li><a href="/auth/login">登录母星网络</a></li>
                <li><a href="/auth/register">注册喵星户籍</a></li>
            {/if}
